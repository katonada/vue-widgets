  ...
  <div>
    ...
    <div class="ecom__price">
      ...
      <template v-if="this.bundleType === 'default'">
        <div class="ecom__price-multi">
          ...
          <div class="ecom__price-old">{{ formatBundlePrice }}</div>
        </div>
      ...
      <template v-else-if="this.bundleType === 'masks'">
        ...
        >
          <p class="ecom__price-old">{{ activeBundleTotalPrice[activeVariation] }}</p>
          <p class="ecom__price-discounted">{{ product.variations[activeVariation].price.original.formatted }}</p>
        </div>
        <div v-else>
      ...
      <template v-else>
        <template v-if="product.variations[activeVariation].price.discounted.formatted">
          <div class="ecom__price-multi">
            ...
            <div class="ecom__price-old">{{ product.variations[activeVariation].price.original.formatted }}</div>
          </div>
          <div class="ecom__price-save">
      ...
      ></afterpay-placement>
      <span v-if="moipLoaded" v-html="moipLoaded" class="ecom__installments-moip"></span>
      <!-- END INSTALLMENTS -->
    </div>
    <!-- END PRICE -->
    ...
    <div class="ecom__atc-buy">
      <template
        ...
        "
      >
        <div class="ecom__btn ecom__btn--disabled" v-html="product.variations[activeVariation].addToCart.title"></div>
      </template>
      <template
        v-else-if="
          product.variations[activeVariation].addToCart.disabled &&
    ...
    <div v-if="popup" class="ecom__popup">
      <div class="ecom__popup-inner">
        <div class="ecom__popup-content">{{ popupContent }}</div>
        <div @click="(popup = false), (buttonDisabled = false)" class="ecom__popup-btn">X</div>
      </div>
    </div>
    <!-- END POPUP WINDOW -->
  </div>
